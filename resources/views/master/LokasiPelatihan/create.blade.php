...
<div class="form-group">
        ...
        {!! Form::text('nama_pelatihan', null, ['class' => 'form-control', 'placeholder' => 'Masukan Lokasi Pelatihan']) !!}
</div>
...
<div class="form-group">
    ...
    {!! Form::submit('Buat Data Lokasi Pelatihan', ['class' => 'btn btn-primary']) !!}
